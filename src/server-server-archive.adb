...
package body Server.Server.Archive is
   ...
   begin
      ...
      Ada.Streams.Stream_IO.Open
        (Create_File, Ada.Streams.Stream_IO.In_File,
      ...
      Hexagon.Server_Map.Load_Map
        (Ada.Strings.Unbounded.To_Unbounded_String
           (Utilities.RemoteString.To_String (P_Directory) & "maps\" &
            Utilities.RemoteString.To_String (P_Create_File_Name)),
      ...
      Hexagon.Server_Navigation.Load_Navigation
        (Ada.Strings.Unbounded.To_Unbounded_String
           (Utilities.RemoteString.To_String (P_Directory) & "land_navigation\" &
            Utilities.RemoteString.To_String (P_Create_File_Name)),
      ...
      Hexagon.Server_Navigation.Load_Navigation
        (Ada.Strings.Unbounded.To_Unbounded_String
           (Utilities.RemoteString.To_String (P_Directory) & "water_navigation\" &
            Utilities.RemoteString.To_String (P_Create_File_Name)),
         Hexagon.Server_Navigation.Get_Navigation
           (Hexagon.Server_Navigation.A_Navigation_List, 2).all);
      --

      Piece.Server.Load_Pieces
        (Ada.Strings.Unbounded.To_Unbounded_String
           (Utilities.RemoteString.To_String (P_Directory) & "pieces\" &
            Utilities.RemoteString.To_String (P_Create_File_Name)),
