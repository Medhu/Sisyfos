...
package body Server.Server.Archive is
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Server.Server.Archive.Creating_Game - enter P_Create_File_Name=" &
      ...
      Hexagon.Server_Map.Load_Map
        (Ada.Strings.Unbounded.To_Unbounded_String
           (Utilities.RemoteString.To_String (P_Directory) & "maps\" & Utilities.RemoteString.To_String (P_Create_File_Name)));

      Piece.Server.Load_Pieces
        (Ada.Strings.Unbounded.To_Unbounded_String
           (Utilities.RemoteString.To_String (P_Directory) & "pieces\" & Utilities.RemoteString.To_String (P_Create_File_Name)),
...
--      use Utilities.RemoteString;
   begin
      ...
      Player.Type_Player_Id'Write (Save_Stream, P_Current_Player_Id);
      ...
      Hexagon.Server_Map.Save_Map
        (Ada.Strings.Unbounded.To_Unbounded_String
           (Utilities.RemoteString.To_String (P_Directory) & "maps\" & Utilities.RemoteString.To_String (P_Save_File_Name)));

      Piece.Server.Save_Pieces
        (Ada.Strings.Unbounded.To_Unbounded_String
           (Utilities.RemoteString.To_String (P_Directory) & "pieces\" & Utilities.RemoteString.To_String (P_Save_File_Name)),
         Piece.Server.All_Pieces_In_Game);
   ...
   is
      ...
      Piece_File_Name  : Utilities.RemoteString.Type_String;

--      use Utilities.RemoteString;
   begin
      if Verbose then
         Text_IO.Put_Line ("Server.Server.Archive.Loading_Game - enter P_Loading_File_Name=" &
      ...
      Utilities.RemoteString.Type_String'Read (Load_Stream, P_Scenario_Name);
         ...
         Text_IO.Put_Line ("Server.Server.Archive.Loading_Game - P_Scenario_Name=" &
                             Utilities.RemoteString.To_String(P_Scenario_Name) );

      Integer'Read (Load_Stream, P_Countdown);
      Player.Type_Player_Id'Read (Load_Stream, P_Current_Player_Id);
      ...
      Hexagon.Server_Map.Load_Map
        (Ada.Strings.Unbounded.To_Unbounded_String
           (Utilities.RemoteString.To_String (P_Directory) & "maps\" & Utilities.RemoteString.To_String (P_Load_File_Name)));

      Piece.Server.Load_Pieces
        (Ada.Strings.Unbounded.To_Unbounded_String
           (Utilities.RemoteString.To_String (P_Directory) & "pieces\" & Utilities.RemoteString.To_String (P_Load_File_Name)),
         Piece.Server.All_Pieces_In_Game);
