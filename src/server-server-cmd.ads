...
package Server.Server.Cmd is
   ...
   type Type_Perform_Patch_Effect is record
      ...
      Effect_To_Perform             : Effect.Type_Effect;
   ...
   type Type_Revoke_Piece_Effect is record
      ...
      Effect_To_Revoke                     : Effect.Type_Effect;
   end record;
   ...
   package Cmd_List_Pkg is new Ada.Containers.Vectors
     (Positive,
      Type_Pointer_To_Cmd);

   procedure Free_Cmd is new Ada.Unchecked_Deallocation
     (Object => Type_Cmd,
