...
package body Server.Server.Piece_Action is
   ...
   procedure Execute_Cmds
     (P_Cmd_List : in out Server.Cmd.Cmd_List_Pkg.Vector)
   is
               ...
               begin
                  ...
                  Server.Piece_Action.Init_Piece
                    (A_Cmd.all.Create_Piece_Details.Player_Id,
                     A_Cmd.all.Create_Piece_Details.Action_Type,
                     A_Cmd.all.Create_Piece_Details.Pos,
                     A_Cmd.all.Create_Piece_Details.Piece_To_Create,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
            ...
            if A_Cmd.all.Attempts_Remaining > 0 then
               ...
               begin
                  ...
                  Server.Piece_Action.Put_Piece
                    (A_Cmd.all.Put_Piece_Details.Player_Id,
                     A_Cmd.all.Put_Piece_Details.Action_Type,
                     A_Cmd.all.Put_Piece_Details.Pos,
                     A_Cmd.all.Put_Piece_Details.Piece_Id_To_Put,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
               ...
               begin
                  ...
                  Server.Piece_Action.Remove_Piece
                    (A_Cmd.all.Remove_Piece_Details.Player_Id,
                     ...
                     A_Cmd.all.Remove_Piece_Details.Piece_Id_To_Remove,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
               ...
               begin
                  ...
                  Server.Piece_Action.Perform_Attack
                    (A_Cmd.all.Perform_Attack_Details.Player_Id,
                     ...
                     A_Cmd.all.Perform_Attack_Details.Attacked_Piece_Id,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
               ...
               begin
                  ...
                  Server.Piece_Action.Perform_Ranged_Attack
                    (A_Cmd.all.Perform_Ranged_Attack_Details.Player_Id,
                     ...
                     A_Cmd.all.Perform_Ranged_Attack_Details
                       .Attacking_Piece_Id,
                     A_Cmd.all.Perform_Ranged_Attack_Details.Attacked_Piece_Id,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
               ...
               begin
                  ...
                  Server.Piece_Action.Perform_Move
                    (A_Cmd.all.Perform_Move_Details.Player_Id,
                     ...
                     A_Cmd.all.Perform_Move_Details.To_Pos,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
               ...
               begin
                  ...
                  Server.Piece_Action.Perform_Patch_Effect
                    (A_Cmd.all.Perform_Patch_Effect_Details.Player_Id,
                     ...
                     A_Cmd.all.Perform_Patch_Effect_Details
                       .Piece_Id_To_Perform_Effect_On,
                     A_Cmd.all.Perform_Patch_Effect_Details.Effect_To_Perform,
                     A_Cmd.all.Perform_Patch_Effect_Details.Area.all,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
               ...
               begin
                  ...
                  Server.Piece_Action.Perform_Piece_Effect
                    (A_Cmd.all.Perform_Piece_Effect_Details.Player_Id,
                     ...
                     A_Cmd.all.Perform_Piece_Effect_Details
                       .Piece_Id_To_Perform_Piece_Effect_On,
                     A_Cmd.all.Perform_Piece_Effect_Details.Effect_To_Perform,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
               ...
               begin
                  Server.Piece_Action.Grant_Piece_Effect
                    (A_Cmd.all.Grant_Piece_Effect_Details.Player_Id,
                     ...
                     A_Cmd.all.Grant_Piece_Effect_Details
                       .Piece_Id_To_Grant_Piece_Effect_On,
                     A_Cmd.all.Grant_Piece_Effect_Details.Effect_To_Grant,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
               ...
               begin
                  ...
                  Server.Piece_Action.Revoke_Piece_Effect
                    (A_Cmd.all.Revoke_Piece_Effect_Details.Player_Id,
                     ...
                     A_Cmd.all.Revoke_Piece_Effect_Details
                       .Piece_Id_To_Revoke_Piece_Effect_From,
                     A_Cmd.all.Revoke_Piece_Effect_Details.Effect_To_Revoke,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
               ...
               begin
                  ...
                  Server.Piece_Action.Grant_Patch_Effect
                    (A_Cmd.all.Grant_Patch_Effect_Details.Player_Id,
                     ...
                     A_Cmd.all.Grant_Patch_Effect_Details.Area.all,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
               ...
               begin
                  ...
                  Server.Piece_Action.Revoke_Patch_Effect
                    (A_Cmd.all.Revoke_Patch_Effect_Details.Player_Id,
                     ...
                     A_Cmd.all.Revoke_Patch_Effect_Details.Effect_To_Revoke,
                     A_Cmd.all.Revoke_Patch_Effect_Details.Area.all,
                     Ret_Status,
                     A_Cmd.all.Attempts_Remaining);
      ...
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Execute_Cmds - Exception:");
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Attempting command:" &
            A_Cmd.all.P_Cmd_Type'Img &
            " at attempt number:" &
            A_Cmd.all.Attempt_Number'Img &
            " remaining attempts:" &
...
--           -- Put the piece on the map
               ...
               Utilities.RemoteString.To_Unbounded_String
                 ("Piece " &
                  Utilities.RemoteString.To_String
                    (Piece.Server.Get_Type_Of_Piece_Name
                       (Piece.Type_Piece (P_Piece.all))) &
                  " # " &
                  P_Piece.Id'Img));
         end if;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Init_Piece - exit P_Status=" &
            P_Status'Img);
      end if;
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Init_Piece - Exception:");
         Text_IO.Put
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
   ...
   begin
      ...
      if A_Piece_Position.Actual_Piece = null then
         ...
         Piece.Server.End_Put_Piece
           (P_Player_Id,
            P_Action_Type,
            P_Pos,
            Piece.Server.Type_Piece'Class (A_Piece_Position.Actual_Piece.all),
            P_Status,
            P_Attempts_Remaining);
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Put_Piece - exit " & P_Status'Img);
      end if;
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Put_Piece - Exception:");
         Text_IO.Put
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
      ...
      if A_Piece_Position.Actual_Piece = null then
         ...
         A_Patch :=
           Hexagon.Server_Map.Get_Patch_Adress_From_AB
             (A_Piece_Position.Actual_Pos.A,
              A_Piece_Position.Actual_Pos.B);
   ...
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Remove_Piece - Exception:");
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
   ...
   is
      An_Attacking_Patch,
      An_Attacked_Patch : Hexagon.Server_Map.Type_Server_Patch_Adress;
      An_Attacking_Piece_Position,
      An_Attacked_Piece_Position : Piece.Server.Type_Piece_Position;
      Result_Status              : Status.Type_Result_Status;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Perform_Attack - enter");
      end if;
      P_Status := Status.Ok;

      begin
         An_Attacking_Piece_Position :=
           Piece.Server.Find_Piece_In_List (P_Attacking_Piece_Id);
      exception
         when Piece.Server.Piece_Not_Found_Piece_Position =>
      ...
      begin
         An_Attacked_Piece_Position :=
           Piece.Server.Find_Piece_In_List (P_Attacked_Piece_Id);
      exception
         when Piece.Server.Piece_Not_Found_Piece_Position =>
      ...
      if An_Attacking_Piece_Position.Actual_Piece = null then
         ...
         Server.Player_Activity_Report_Append
           (1,
            P_Player_Id,
            Utilities.RemoteString.To_Unbounded_String
              ("Perform Attack Attacking Piece Id:" &
         ...
         Server.Player_Activity_Report_Append
           (1,
            P_Player_Id,
            Utilities.RemoteString.To_Unbounded_String
              ("Perform Attack Attacked Piece Id:" &
         ...
         An_Attacking_Patch :=
           Hexagon.Server_Map.Get_Patch_Adress_From_AB
             (An_Attacking_Piece_Position.Actual_Pos.A,
              An_Attacking_Piece_Position.Actual_Pos.B);
         An_Attacked_Patch :=
           Hexagon.Server_Map.Get_Patch_Adress_From_AB
             (An_Attacked_Piece_Position.Actual_Pos.A,
              An_Attacked_Piece_Position.Actual_Pos.B);
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Perform_Attack - exit P_Status=" &
            P_Status'Img);
      end if;
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Perform_Attack - Exception:");
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
   ...
   begin
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Perform_Ranged_Attack - enter");
      end if;
      P_Status := Status.Ok;
      ...
      if An_Attacking_Piece_Position.Actual_Piece = null then
         ...
         Server.Player_Activity_Report_Append
           (1,
            P_Player_Id,
            Utilities.RemoteString.To_Unbounded_String
              ("Perform Ranged Attack Attacking Piece Id:" &
               P_Attacking_Piece_Id'Img &
               " not valid. Command will be cancelled."));
      elsif An_Attacked_Piece_Position.Actual_Piece = null then
         P_Attempts_Remaining := 0;
         ...
         Server.Player_Activity_Report_Append
           (1,
            P_Player_Id,
            Utilities.RemoteString.To_Unbounded_String
              ("Perform Ranged Attack Attacked Piece Id:" &
               P_Attacked_Piece_Id'Img &
               " not valid. Command will be cancelled."));
      elsif not An_Attacking_Piece_Position.Actual_Pos.P_Valid then
         P_Attempts_Remaining := 0;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Perform_Ranged_Attack - exit P_Status=" &
            P_Status'Img);
      end if;
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Perform_Ranged_Attack - Exception:");
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
   ...
   is
      ...
      A_From_Patch,
      A_To_Patch : Hexagon.Server_Map.Type_Server_Patch_Adress :=
        null;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Perform_Move - enter P_Piece_Id=" &
            P_Piece_Id'Img);
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Perform_Move - exit P_Status=" &
            P_Status'Img);
      end if;
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Perform_Move - Exception:");
         Text_IO.Put
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
   ...
   begin
      ...
      if A_Piece_Position.Actual_Piece = null then
         ...
         if not Piece.Server.Validate_Patch_Effect
             (P_Action_Type,
              Piece.Server.Type_Piece (A_Piece_Position.Actual_Piece.all),
              P_Effect,
              P_Area)
         then
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Perform_Patch_Effect - exit P_Status=" &
            P_Status'Img);
      end if;
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Perform_Patch_Effect - Exception:");
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
   ...
   begin
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Perform_Piece_Effect - enter P_Piece_Id=" &
            P_Piece_Id'Img);
      end if;
      P_Status := Status.Ok;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Perform_Piece_Effect - exit P_Status=" &
            P_Status'Img);
      end if;
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Perform_Piece_Effect - Exception:");
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
   ...
   begin
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Grant_Piece_Effect- enter");
      end if;
      P_Status := Status.Ok;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Grant_Piece_Effect- exit");
      end if;
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Grant_Piece_Effect - Exception:");
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
   ...
   begin
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Revoke_Piece_Effect- enter");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Revoke_Piece_Effect- exit");
      end if;
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Revoke_Piece_Effect - Exception:");
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
   ...
   begin
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Grant_Patch_Effect- enter");
      end if;
      P_Status := Ok;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Grant_Patch_Effect- exit");
      end if;
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Grant_Patch_Effect:");
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
   ...
   begin
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Revoke_Patch_Effect- enter P_Piece_Id=" &
            P_Piece_Id'Img);
      end if;
      P_Status := Status.Ok;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Server.Server.Piece_Action.Revoke_Patch_Effect- exit");
      end if;
   exception
      when others =>
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Server.Server.Piece_Action.Revoke_Patch_Effect - Exception:");
         Text_IO.Put_Line
           (Text_IO.Current_Error,
            "Player_Id:" &
            P_Player_Id'Img &
