...
package Piece.Server is
   ...
   function Observation_Area
     (P_Piece : in Type_Piece) return Hexagon.Area.Server_Area
     .Type_Action_Capabilities_Access is abstract;

   package Pieces_Server_List is new Ada.Containers.Vectors (Natural, Type_Piece_Position,
      Piece.Server."=");

   function Find_Piece_In_List (P_Piece_Id : in Piece.Type_Piece_Id) return Type_Piece_Position;

   function Left_Less_Pieces (Left, Right : in Type_Piece_Access_Class) return Boolean;

   function Equal_Pieces (Left, Right : in Type_Piece_Access_Class) return Boolean;
   ...
   procedure Set_Position (P_Piece : in Type_Piece; P_Pos : in Hexagon.Type_Hexagon_Position);
   procedure Unset_Position (P_Piece : in Type_Piece; P_Pos : in Hexagon.Type_Hexagon_Position);
   ...
   procedure Delete_Piece (P_Server_Piece : in out Piece.Server.Type_Piece_Access_Class);
   ...
   procedure Perform_Patch_Effect (P_Player_Id : in Player.Type_Player_Id;
      ...
      P_Effect_Name                                 : in Effect.Type_Effect_Name) is abstract;
   ...
   procedure End_Perform_Patch_Effect (P_Player_Id : in Player.Type_Player_Id;
      P_Action_Type : in Action.Type_Action_Type; P_Piece : in out Piece.Server.Type_Piece;
      P_Effect_Name : in Effect.Type_Effect_Name; P_Area : in Hexagon.Area.Type_Action_Capabilities_A;
      P_End_Status : in Status.Type_Status; P_Attempts_Remaining : in out Integer) is abstract;
   ...
   procedure Before_Grant_Piece_Effect (P_Player_Id : in Player.Type_Player_Id;
      P_Action_Type : in Action.Type_Action_Type; P_Piece : in out Piece.Server.Type_Piece;
      P_Effect : in Effect.Type_Effect; P_Result : out Status.Type_Result_Status) is abstract;
   ...
   procedure Before_Revoke_Patch_Effect (P_Player_Id : in     Player.Type_Player_Id;
      P_Action_Type : in     Action.Type_Action_Type; P_Piece : in out Piece.Server.Type_Piece;
      P_Area                                         : in Hexagon.Area.Type_Action_Capabilities_A;
      P_Effect_Name                                  : in     Effect.Type_Effect_Name;
      P_Result                                       : out Status.Type_Result_Status) is abstract;
   ...
   function Get_Pieces_Players (P_Patch : in Landscape.Type_Patch) return Player.Type_Player_Id;
   ...
   procedure Free_Piece is new Ada.Unchecked_Deallocation (Object => Piece.Server.Type_Piece'Class,
