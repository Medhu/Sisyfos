...
package body Piece.Server.Fighting_Piece is
   ...
   begin
      ...
      if P_Winner = P_Attacked_Piece.Player_Id then
         ...
         -- If the 'Winner' is neither of the two attacking/attacked piece
         -- and the winner is also not 'Undefined_Player_Id',
         -- then we raise an exception
         raise Winner_Not_Returned_Properly with "Winner Player_Id:" & P_Winner'Img
           & " is not one of Attacking Player_Id:" & P_Attacking_Piece.Player_Id'Img
           & ", Attacked Player_Id:" & P_Attacked_Piece.Player_Id'Img
           & " or Player.Undefined_Player_Id";
   ...
   begin
      ...
      -- Undefined_Player_Id here.
         ...
         -- If the 'Winner' is neither attacking piece or 'Undefined_Player_Id',
         -- then we raise an exception
         raise Winner_Not_Returned_Properly with "Winner Player_Id:" & P_Winner'Img
           & " is not one of Attacking Player_Id:" & P_Attacking_Piece.Player_Id'Img
           & " or Player.Undefined_Player_Id";
