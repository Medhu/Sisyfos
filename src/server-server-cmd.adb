...
--
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Server.Server.Cmd.Perform_Construction - enter");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Server.Server.Cmd.Perform_Construction - exit");
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Server.Server.Cmd.Perform_Demolition - enter");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Server.Server.Cmd.Perform_Demolition - exit");
      end if;
