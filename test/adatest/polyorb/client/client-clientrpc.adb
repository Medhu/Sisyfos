...
package body Client.ClientRPC is
   ...
   begin
      ...
      Test_ServerRCI.Get_Server_Info (P_Server_Info, P_Status);
   ...
   begin
      ...
      Test_ServerRCI.Create_Piece (P_Player_Id, P_Action_Type, P_Pos, P_Piece);
   ...
   begin
      ...
      Test_ServerRCI.Put_Piece (P_Player_Id, P_Action_Type, P_Pos, P_Piece_Id);
   ...
   begin
      ...
      Test_ServerRCI.Remove_Piece (P_Player_Id, P_Action_Type, P_Piece_Id);
   ...
   begin
      ...
      Test_ServerRCI.Get_Pieces_Report (P_Player_Id, P_Visibility_Frames);
   ...
   begin
      ...
      Test_ServerRCI.Perform_Ranged_Attack
        (P_Player_Id,
         P_Action_Type,
         P_Attacking_Piece_Id,
         P_Attacked_Piece_Id);
   ...
   begin
      if Verbose then
         Text_IO.Put_Line
           ("Client.ClientRPC.Perform_Move - enter P_Piece_Id=" &
            P_Piece_Id'Img &
            " P_Player_id=" &
            P_Player_Id'Img);
      end if;

      Test_ServerRCI.Perform_Move (P_Player_Id, P_Action_Type, P_Piece_Id, P_To_Pos);
   ...
   begin
      ...
      Test_ServerRCI.Perform_Patch_Effect
        (P_Player_Id,
         P_Action_Type,
         P_Piece_Id,
         P_Effect_Name,
   ...
   begin
      ...
      Test_ServerRCI.Perform_Piece_Effect (P_Player_Id, P_Action_Type, P_Piece_Id, P_Effect_Name);
   ...
   begin
      ...
      Test_ServerRCI.Grant_Piece_Effect (P_Player_Id, P_Action_Type, P_Piece_Id, P_Effect);
   ...
   begin
      ...
      Test_ServerRCI.Revoke_Piece_Effect (P_Player_Id, P_Action_Type, P_Piece_Id, P_Effect_Name);
   ...
   begin
      ...
      Test_ServerRCI.Grant_Patch_Effect (P_Player_Id, P_Action_Type, P_Piece_Id, P_Effect, P_Area);
   ...
   begin
      ...
      Test_ServerRCI.Revoke_Patch_Effect (P_Player_Id, P_Action_Type, P_Piece_Id, P_Effect_Name, P_Area);
   ...
   begin
      ...
      Test_ServerRCI.Get_Map (P_Server_Map);
   ...
   begin
      ...
      Test_ServerRCI.Create_Game (P_Create_File_Name, P_Player_Name_List, P_Status);
      if Verbose then
   ...
   begin
      ...
      Test_ServerRCI.Save_Game (P_Save_File_Name, P_Status);
   ...
   begin
      ...
      Test_ServerRCI.Load_Game (P_Load_File_Name, P_Status);
   ...
   begin
      ...
      Test_ServerRCI.Join_Game (P_Player_Name, P_Status, Player_Id);
   ...
   begin
      ...
      Test_ServerRCI.Leave_Game (P_Player_Id, P_Player_Name, P_Status);
   ...
   begin
      ...
      Player_Name := Test_ServerRCI.Get_Player_Name (P_Player_Id, P_Status);
   ...
   begin
      ...
      Test_ServerRCI.Client_Stopped (P_Player_Id);
