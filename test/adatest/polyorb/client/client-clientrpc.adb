...
package body Client.ClientRPC is
   ...
   begin
      ...
      Test_ServerRCI.Perform_Piece_Effect
        (P_Action_Type,
         P_Piece_Id,
         P_Pos,
         P_Effect,
   ...
   begin
      ...
      Test_ServerRCI.Grant_Piece_Effect
        (P_Action_Type,
         P_Piece_Id,
         P_Effect,
         P_Player_Id,
   ...
   begin
      ...
      Test_ServerRCI.Revoke_Piece_Effect
        (P_Action_Type,
         P_Piece_Id,
         P_Effect,
         P_Player_Id,
   ...
   begin
      ...
      Ret := Test_ServerRCI.End_Turn (P_Player_Id);
   ...
   begin
      ...
      --Ret := Test_ServerRCI.Observation_Area(P_Piece_Id);

      --      if Tmp /= null then
      declare
         Ret : Hexagon.Area.Type_Action_Capabilities :=
           Test_ServerRCI.Observation_Area (P_Piece_Id);
      begin
         -- Free Tmp!!
         if Verbose then
            Text_IO.Put_Line
   ...
   begin
      ...
      declare
         Ret : Hexagon.Area.Type_Action_Capabilities :=
           Test_ServerRCI.Movement_Capability (P_Piece_Id);
      begin
         -- Free Tmp!!
         if Verbose then
            Text_IO.Put_Line
   ...
   begin
      ...
      declare
         Ret : Hexagon.Area.Type_Action_Capabilities :=
           Test_ServerRCI.Attack_Capability (P_Piece_Id);
      begin
         -- Free Tmp!!
         if Verbose then
            Text_IO.Put_Line
