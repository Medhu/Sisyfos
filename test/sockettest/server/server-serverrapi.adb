...
package body Server.ServerRAPI is
   ...
   begin
      ...
      if P_Player_Id /= 1 then
         Text_IO.Put_Line ("Perform_Construction: Player_Id:" & P_Player_Id'Img & " expected 1");
         Text_IO.Put_Line ("Perform_Construction                                    - Failed");
      elsif P_Action_Type /= 2 then
         Text_IO.Put_Line
           ("Perform_Construction: P_Action_Type:" & P_Action_Type'Img & " expected 2");
         Text_IO.Put_Line ("Perform_Construction                                    - Failed");
      elsif P_Piece_Id /= 3 then
         Text_IO.Put_Line ("Perform_Construction: P_Piece_Id:" & P_Piece_Id'Img & " expected 3");
         Text_IO.Put_Line ("Perform_Construction                                    - Failed");
      elsif P_Construction_Pos /= Hexagon.Type_Hexagon_Position'(True, 4, 5) then
         Text_IO.Put_Line ("Perform_Construction: P_Pos:-----");
         Text_IO.Put_Line ("Perform_Construction                                    - Failed");
      elsif P_Construction /= 6 then
         Text_IO.Put_Line ("Perform_Construction: P_Construction:" & P_Construction'Img);
         Text_IO.Put_Line ("Perform_Construction                                    - Failed");
      else
         Text_IO.Put_Line ("Perform_Construction                                    - OK");
      end if;
   ...
   begin
      ...
      if P_Player_Id /= 1 then
         Text_IO.Put_Line ("Perform_Demolition: Player_Id:" & P_Player_Id'Img & " expected 1");
         Text_IO.Put_Line ("Perform_Demolition                                      - Failed");
      elsif P_Action_Type /= 2 then
         Text_IO.Put_Line
           ("Perform_Demolition: P_Action_Type:" & P_Action_Type'Img & " expected 2");
         Text_IO.Put_Line ("Perform_Demolition                                      - Failed");
      elsif P_Piece_Id /= 3 then
         Text_IO.Put_Line ("Perform_Demolition: P_Piece_Id:" & P_Piece_Id'Img & " expected 3");
         Text_IO.Put_Line ("Perform_Demolition                                      - Failed");
      elsif P_Demolition_Pos /= Hexagon.Type_Hexagon_Position'(True, 4, 5) then
         Text_IO.Put_Line ("Perform_Demolition: P_Pos:-----");
         Text_IO.Put_Line ("Perform_Demolition                                      - Failed");
      elsif P_Construction /= 6 then
         Text_IO.Put_Line ("Perform_Demolition: P_Construction:" & P_Construction'Img);
         Text_IO.Put_Line ("Perform_Demolition                                      - Failed");
      else
         Text_IO.Put_Line ("Perform_Demolition                                      - OK");
      end if;
