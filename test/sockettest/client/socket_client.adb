...
begin
   ...
   Client.ClientRPC.Connect (Utilities.RemoteString.To_Unbounded_String ("10.0.1.11"), 4000);
   ...
   Client.ClientRPC.Perform_Patch_Effect (1, 2, 3, Effect.Type_Effect'(4, 5), An_Area);

   Client.ClientRPC.Perform_Piece_Effect (1, 2, 3, Effect.Type_Effect'(4, 5));

   Client.ClientRPC.Grant_Piece_Effect (1, 2, 3, Effect.Type_Effect'(4, 5));

   Client.ClientRPC.Revoke_Piece_Effect (1, 2, 3, Effect.Type_Effect'(4, 5));

   Client.ClientRPC.Grant_Patch_Effect (1, 2, 3, Effect.Type_Effect'(4, 5), An_Area);

   Client.ClientRPC.Revoke_Patch_Effect (1, 2, 3, Effect.Type_Effect'(4, 5), An_Area);

   Client.ClientRPC.Perform_Construction (1, 2, 3, Hexagon.Type_Hexagon_Position'(True, 4, 5), 6);

   Client.ClientRPC.Perform_Demolition (1, 2, 3, Hexagon.Type_Hexagon_Position'(True, 4, 5), 6);
